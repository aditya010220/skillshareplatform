  ...
  const communityMembers = [
    {
      ...
      bio: 'Passionate about web development and helping others learn coding. 5+ years of experience in React and Node.js.',
    ...
    },
    {
      ...
      bio: 'Marketing expert with a passion for data-driven strategies. Love sharing knowledge about SEO and content marketing.',
    ...
    },
    {
      ...
      title: 'Language Teacher & Photographer',
      bio: 'Native Spanish speaker and professional photographer. Passionate about languages and visual storytelling.',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=emily',
      rating: 4.7,
      totalSessions: 52,
      location: 'Austin, TX',
      badges: ['Language Expert', 'Photo Pro', 'Cultural Ambassador'],
      skills: ['Spanish', 'Photography', 'Adobe Lightroom', 'Travel'],
    ...
    },
    {
      ...
      bio: 'Data scientist by day, fitness enthusiast by night. Combining tech skills with health and wellness expertise.',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=david',
      rating: 4.6,
      totalSessions: 29,
      location: 'Seattle, WA',
      badges: ['Data Expert', 'Fitness Pro'],
    ...
    },
    {
      ...
      bio: 'Helping businesses grow while pursuing creative passions. Love the intersection of strategy and creativity.',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=anna',
      rating: 4.9,
      totalSessions: 41,
      location: 'Chicago, IL',
      badges: ['Business Expert', 'Creative Soul', 'Mentor'],
      skills: ['Business Strategy', 'Watercolor', 'Public Speaking', 'Art'],
    ...
    },
    {
      ...
      bio: 'Professional chef with 15 years of experience. Passionate about teaching cooking techniques and food culture.',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=carlos',
      rating: 4.8,
      totalSessions: 67,
      location: 'Miami, FL',
      badges: ['Master Chef', 'Food Educator', 'Top Rated'],
      skills: ['Cooking', 'Baking', 'Food Photography', 'Nutrition'],
